...
const Home = () => {
    ...
    return (
        <>
            <nav className="bg-white z-40 py-8 px-16 flex justify-between w-screen fixed border-b-2 border-gray-50">
            ...
            <div className="w-full h-2/3 py-20 pt-40 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-20">
                ...
                <Fade className="w-full sm:p-10 sm:w-1/2" triggerOnce direction='right' fraction={0.5}>
            ...
            <div className="w-full h-fit">
                <div className="bg-custom-color w-full h-fit pb-10">
                    <Fade triggerOnce direction='up' fraction={0.5}>
                        <h1 className="font-bold text-5xl px-20 text-center py-10 text-white">Inteligencia artificial</h1>
                    </Fade>
                    <Fade triggerOnce direction='up' fraction={0.5}>
                ...
                <div className="w-full h-2/3 py-16 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-20">
                    {/* <div className="w-full h-screen flex items-center justify-center gap-20"> */}
                    <div className="w-full text-center p-10 sm:text-left sm:w-1/3">
                        <Fade triggerOnce direction='left' fraction={1}>
                    ...
                    <Fade triggerOnce direction='right' fraction={1}>
